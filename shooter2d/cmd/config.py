...
class Config:
    class Game:
        ...
        MAX_BLINK_RANGE = int(os.getenv("MAX_BLINK_RANGE", 0)) or 420

        BULLET_SPEED = int(os.getenv("BULLET_SPEED", 0)) or 640
        ...
        PLAYER_SPEED = float(os.getenv("PLAYER_SPEED", 0)) or 320
        PLAYER_RADIUS = int(os.getenv("PLAYER_RADIUS", 0)) or 10

        LAG_RADIUS = int(os.getenv("PLAYER_RADIUS", 0)) or 10
